...
const features = [
  ...
  },
  {
    ...
    description: 'Years of experience delivering digital marketing excellence.'
  },
  {
    icon: Clock,
    title: 'Dedicated Support',
    description: 'Responsive assistance for all your marketing needs.'
  },
  {
    icon: Zap,
    title: 'Fast Results',
...
const stats = [
  ...
  { value: 150, suffix: '%', label: 'Average Growth' },
